...
\copy (select id2, site_id, identifiant from cinema.links_societes order by id2) to '../data/cinema/links_societes.csv' (format csv, header, encoding 'utf8');
\copy (select id2, site_id, identifiant from cinema.links_personnes order by id2) to '../data/cinema/links_personnes.csv' (format csv, header, encoding 'utf8');
\copy (select id2, site_id, identifiant from cinema.links_films order by id2) to '../data/cinema/links_films.csv' (format csv, header, encoding 'utf8');
...
\copy (select f_id, langue_code, resume from cinema.resumes where resume <> '' order by f_id) to '../data/cinema/resumes.csv' (format csv, header, delimiter ',', encoding 'utf8');
